            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="pPhone1" id="pPhone1" class="pPhone" readonly="readonly" maxlength="4" value="010"/> - 
                        <input type="text" name="pPhone2" class="pPhone" maxlength="4"/> - 
                        <input type="text" name="pPhone3" class="pPhone" maxlength="4"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
